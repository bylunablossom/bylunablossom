...
// ── 4. Politica de privacidade: remove TODOS os checkboxes existentes e adiciona 1 novo ──
// Remover qualquer div wrapper com privacyCheck (todas as ocorrencias)
html = html.replace(/<div[^>]*>\s*<label[^>]*>\s*<input[^>]*id="privacyCheck"[\s\S]*?<\/label>\s*<\/div>\s*/g, '');
